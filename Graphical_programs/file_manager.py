...
Label(window, text="چه کاری انجام دهم؟").pack(pady= 10)

Button(window, command=open_file, text="بازکردن فایل",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=copy_file, text="کپی فایل",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=delete_file, text="حذف فایل",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=rename_file, text="تغییر نام فایل",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=move_file, text="انتقال فایل",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=make_directory, text="ایجاد فولدر",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=remove_directory, text="حذف فولدر",fg="blue", activebackground="red", bg="white").pack(pady= 20)
Button(window, command=list_files, text="لیست تمام فایل ها",fg="blue", activebackground="red", bg="white").pack(pady= 20)
