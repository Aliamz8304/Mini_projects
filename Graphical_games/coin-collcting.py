...
while running:
    ...
    if not game_over:
        ...
        if key[pygame.K_RIGHT] and player_x < screen_width - player_width:
            player_x += player_speed
    ...
    if game_over:
        ...
        screen.blit(restart_text, (screen_width // 2 - game_over_text.get_width() // 2,
                                    screen_height // 2 - game_over_text.get_height() // 2 + 60))
