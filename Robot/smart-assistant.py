...
def welcome():
    ...
    while True:
        ...
        if NAME != "none":
            break
    print(f"Welcome {NAME.capitalize()}. lets start!\n")
    speak(f"Welcome {NAME.capitalize()}. lets start!")
...
while True:
    ...
    if "bye" in command or "stop" in command:
        print(f"Goodbye {NAME.capitalize()}. Have a nice day!\n")
        speak(f"Goodbye {NAME.capitalize()}. Have a nice day!")
        break
    ...
    if "wikipedia" in command:
        ...
        print("Hello. I am version 1 of the voice assistant and was programmed by Ali.\n")
        speak("Hello. I am version 1 of the voice assistant and was programmed by Ali.")
        ...
        os.startfile(os.environ["USERPROFILE"]+ r"\AppData\Roaming\Telegram Desktop\Telegram.exe")
        time.sleep(5)
